...
class TimelinesControllerTest < ActionController::TestCase
  ...
  test "should create timeline" do
    assert_difference('Timeline.count') do
      post :create, timeline: { image_date: @timeline.image_date, image_source: @timeline.image_source, image_url: @timeline.image_url, likes: @timeline.likes, numcomments: @timeline.numcomments, shares: @timeline.shares, user_id: @timeline.user_id }
    end
  ...
  test "should update timeline" do
    patch :update, id: @timeline, timeline: { image_date: @timeline.image_date, image_source: @timeline.image_source, image_url: @timeline.image_url, likes: @timeline.likes, numcomments: @timeline.numcomments, shares: @timeline.shares, user_id: @timeline.user_id }
    assert_redirected_to timeline_path(assigns(:timeline))
  end
